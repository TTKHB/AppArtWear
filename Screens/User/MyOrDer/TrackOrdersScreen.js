...
import { View, Text, Button, StyleSheet, FlatList, ScrollView, Image, StatusBar, Dimensions, TouchableOpacity } from 'react-native';
            ...
            <View style={styles.cardsWrapper}>
                ...
                <View style={styles.card}>
                    <View style={styles.cardImgWrapper}>
                        <Image
                            source={require('../../../assets/images/Banner/SplashScreen.png')}
                            resizeMode="cover"
                        ...
                        ? this.state.contents.map((param, i) => {
                            return (
                                <DropDownItem
                                    ...
                                    header={
                                        <View>
                                            <AwesomeIcon name="chevron-down" size={21} style={{ alignSelf: 'flex-end' }} />
                                        </View>
                                    }
                                >
                                                        ...
                                                        renderLabel={({ position, stepStatus, label, currentPosition }) => {
                                                            return (
                                                                <View style={styles.lblContainer}>
                                                                    ...
                                                                    <Text style={styles.lblStatus, { marginTop: 5 }}>{data[position].status}</Text>
                                                                    <Text style={styles.lblStatus}>{data[position].dateTime}</Text>
