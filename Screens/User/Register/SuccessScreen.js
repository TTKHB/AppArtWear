...
const SuccessScreen = ({ navigation }) => {
    return (
        <View style={styles.container}>
            <View >
                <Image style={{ height: 300, width: 300, marginTop: -100 }} source={require('../../../assets/images/users/HighFive.jpg')} />
            </View>
            <View style={styles.viewTextOne}>
                <Text style={styles.textOne}>Tuyệt vời! Bạn đã đăng ký thành công</Text>
            </View>
