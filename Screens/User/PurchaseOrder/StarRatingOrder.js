...
export const car = require ( '../../../assets/images/car1.png')
const Product=[
{
    id: 1,
    images: ao7,
                 ...
                 return(
                     <View style={styles.container1}>
                        ...
                        <View style={styles.container3}>
                           ...
                           <Text style={{fontSize: 17, color: '#06AB7D',marginLeft: 10}}>Giao hàng thành công</Text>
                        </View>
                       
                        <View style={styles.container5}>
                         <View style={styles.left1}>
                             <Text style={{fontSize: 16, marginTop: 5}}>Đánh giá và nhận xét tại đây, trước ngày 24-04-2021</Text>
